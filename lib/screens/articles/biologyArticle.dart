...
class BiologyArticle extends StatelessWidget{
  const BiologyArticle({super.key});
      ...
      body: Padding(
        ...
        child: SizedBox(
          ...
          child: StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance.collection("topicdb").where("sub", isEqualTo: "Biology").snapshots(),
