...
class HistoryArticle extends StatelessWidget{
  const HistoryArticle({super.key});
      ...
      body: Padding(
        ...
        child: SizedBox(
          ...
          child: StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance.collection("topicdb").where("sub", isEqualTo: "History").snapshots(),
