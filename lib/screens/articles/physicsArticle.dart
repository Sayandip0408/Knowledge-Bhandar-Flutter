...
class PhysicsArticle extends StatelessWidget{
  const PhysicsArticle({super.key});
      ...
      body: Padding(
        ...
        child: SizedBox(
          ...
          child: StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance.collection("topicdb").where("sub", isEqualTo: "Physics").snapshots(),
