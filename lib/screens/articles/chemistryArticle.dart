...
class ChemistryArticle extends StatelessWidget{
  const ChemistryArticle({super.key});
      ...
      body: Padding(
        ...
        child: SizedBox(
          ...
          child: StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance.collection("topicdb").where("sub", isEqualTo: "Chemistry").snapshots(),
